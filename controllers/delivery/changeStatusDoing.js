...
const {order: orderStatus, delivery: deliveryStatus} = require('../../constants/status');
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const result = await model.findOneAndUpdate({_id: id}, {status: deliveryStatus.DOING, startTime}, {returnNewDocument : true});
